...
export function initializeWebRTCAdmin(
    ...
    initReport: ((connection: RTCPeerConnection) => void) | null = null
    ...
    return new Promise((resolve, reject) => {
        ...
        socket.on("webrtc initial answer broadcast", async (other: IIdentity, answer: RTCSessionDescriptionInit) => {
            ...
            connection.onconnectionstatechange = cbInitialConnected(connection, self, other, updateProgress, initReport);
